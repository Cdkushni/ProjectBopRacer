...
#include "ProjectPodracerOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class PROJECTPODRACER_API AProjectPodracerOffroadCar : public AProjectPodracerPawn
{
	GENERATED_BODY()
