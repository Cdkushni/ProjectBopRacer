...
#include "ProjectPodracerSportsCar.h"
#include "ProjectPodracerSportsWheelFront.h"
#include "ProjectPodracerSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AProjectPodracerSportsCar::AProjectPodracerSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProjectPodracerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProjectPodracerSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProjectPodracerSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProjectPodracerSportsWheelRear::StaticClass();
