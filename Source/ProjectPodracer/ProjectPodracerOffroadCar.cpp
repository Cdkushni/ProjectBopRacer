...
#include "ProjectPodracerOffroadCar.h"
#include "ProjectPodracerOffroadWheelFront.h"
#include "ProjectPodracerOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AProjectPodracerOffroadCar::AProjectPodracerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UProjectPodracerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UProjectPodracerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UProjectPodracerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UProjectPodracerOffroadWheelRear::StaticClass();
