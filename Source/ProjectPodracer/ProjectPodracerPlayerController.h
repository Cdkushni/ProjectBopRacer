...
#include "ProjectPodracerPlayerController.generated.h"

class UInputMappingContext;
class AProjectPodracerPawn;
class UProjectPodracerUI;
 ...
 */
UCLASS(abstract)
class PROJECTPODRACER_API AProjectPodracerPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AProjectPodracerPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UProjectPodracerUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UProjectPodracerUI> VehicleUI;
